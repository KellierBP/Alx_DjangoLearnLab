...
SECRET_KEY = 'django-insecure--irwhbgefzn$o5eb^ye(s7%e=rq@7le12o7y@ywxmsxm1xu=49'
...
# CSP reduces XSS risk by specifying allowed content sources
# Note: For production, consider using django-csp package for more control
